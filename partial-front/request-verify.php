...
?>
    <div class="borrow">
        ...
        <?php } elseif ($request_limit_reached || $issue_limit_reached || $book_not_available) { ?>
            <span class="error"><?php echo $book_not_available ? "Book Not Available" : "Request Limit Reached"; ?></span>
