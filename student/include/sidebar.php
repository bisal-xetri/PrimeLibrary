<div class="user-nav">
  ...
  <div><img class="user-info-img" src="iconimage/order1.png" alt=""><a class="user-link" href="requests.php">Issued Book</a></div>
  ...
  <div> <img class="user-info-img" src="iconimage/info.png" alt=""><a class="user-link" href="access-detail.php">Manage Account</a></div>
